							...
							<div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
									<div class="list-group">
										...
										<a href="<c:url value='#'/>" class="list-group-item"> Veículo <span class="glyphicon glyphicon-bed rigth" aria-hidden="true"></span> </a>
									</div>
				...
				<div class="col-sm-9">
					<div class="well col-xs-12">
						<div class="col-xs-3 col-md-4">
							<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addVeiculo">
					...
					<div class="modal fade " id="addVeiculo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									...
									<div class=" row">
										...
										<form data-toggle="validator" role="form">
											...
											<div class="form-group col-sm-5">
												...
												<input type="text" class="form-control" id="veiculo.placa" name="veiculo.placa" required>
											</div>
											...
											<div class="checkbox col-sm-3 col-sm-offset-1 foraUso">
												<label for="veiculo.fora" class="">
													<input type="checkbox" value="" name="veiculo.fora">
													Fora de uso</label>
											</div>
					...
					<div class="tabela">
						<table class="table table-bordered">
							...
							<tr>
								...
								<td> Joao da Silva </td>
								<td>
								<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addVeiculo">
									Editar
								</button></td>
								</td>
							</tr>
