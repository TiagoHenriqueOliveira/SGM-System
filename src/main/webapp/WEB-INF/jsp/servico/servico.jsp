							...
							<div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
									<div class="list-group">
										...
										<a href="<c:url value='#'/>" class="list-group-item"> Serviço <span class="glyphicon glyphicon-wrench rigth" aria-hidden="true"></span> </a>
				...
				<div class="col-sm-9">
					<div class="well col-xs-12">
						<div class="col-xs-3 col-md-4">
							<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addServico">
									...
									<div class=" row">
										...
										<form data-toggle="validator" role="form">
											...
											<div class="form-group col-sm-4">
												<label for="servico.valor" class="control-label">Valor R$:</label>
												<input type="text" class="form-control" id="servico.valor" name="servico.valor" required>
											</div>
											<div class="form-group col-sm-4">
												<label for="servico.tipo" class="control-label">Tipo:</label>
												<input type="text" class="form-control" id="servico.tipo" name="servico.tipo" required>
											</div>
											<div class="checkbox col-sm-3 col-sm-offset-1 foraUso">
												<label for="servico.fora" class=""><input type="checkbox" value="" name="servico.fora">Fora de uso</label>
											</div>
