							...
							<div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
									<div class="list-group">
										...
										<a href="<c:url value='#'/>" class="list-group-item"> Produto <span class="glyphicon glyphicon-oil rigth" aria-hidden="true"></span> </a>
									...
									<div class=" row">
										...
										<form data-toggle="validator" role="form">
											...
											<div class="form-group col-sm-4">
												<label for="produto.valor" class="control-label">Valor R$:</label>
												<input type="text" class="form-control" id="produto.valor" name="produto.valor" required>
											</div>
											<div class="form-group col-sm-4">
												<label for="produto.tipo" class="control-label">Tipo:</label>
												<input type="text" class="form-control" id="produto.tipo" name="produto.tipo" required>
											</div>
											<div class="checkbox col-sm-3 col-sm-offset-1 foraUso">
												<label for="produto.fora" class=""><input type="checkbox" value="" name="produto.fora">Fora de uso</label>
											</div>
					...
					<div class="tabela">
						<table class="table table-bordered">
							...
							<tr>
								...
								<td> Suberbo </td>
								<td>
								<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addProduto">
									Editar
								</button></td>
								</td>
							</tr>
