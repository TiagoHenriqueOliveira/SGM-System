							...
							<div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
									<div class="list-group">
										...
										<a href="<c:url value='#'/>" class="list-group-item"> Usuario <span class="glyphicon glyphicon-user rigth" aria-hidden="true"></span> </a>
				...
				<div class="col-sm-9">
					<div class="well col-xs-12">
						<div class="col-xs-3 col-md-4">
							<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addUsuario">
									...
									<div class=" row">
										...
										<form data-toggle="validator" role="form">
											...
											<div class="form-group col-sm-6">
												...
												<input type="password" class="form-control" id="usuario.senha" name="usuario.senha" required>
											</div>
											<div class="checkbox col-sm-5 col-sm-offset-1 foraUso">
												<label for="usuario.fora" class=""><input type="checkbox" value="" name="usuario.fora">Fora de uso</label>
											</div>
					...
					<div class="tabela col-sm-8">
						<table class="table table-bordered">
							...
							<tr>
								...
								<td> JOAO </td>
								<td>
								<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addUsuario">
									Editar
								</button></td>
							</tr>
